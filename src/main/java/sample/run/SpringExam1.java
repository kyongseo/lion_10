...
public class SpringExam1 {
    ...
    public static void main(String[] args) {
        ...
        // 공장이 생성될 때 어떤 빈을 생성해야 할지 알아야 함 -> MyBeanConfig.class에 있는 빈을 등록해달라고 하는 구문
        ...
        // 빈에 아이디가 아닌 타입을 넣어서 호츌하기
        // MyBean bean2 = context.getBean("myBean.class"); // 해당 타입의 객체가 하나만 존재할 경우는 오류가 없음
        // 빈이 2개 일때는 오류생성되어 아래처럼 작성
        MyBean bean2 = context.getBean("myBean2", MyBean.class); // 아이디가 아닌 타입만 알려준 것 -> 즉, 유추해서 하나만 골라줌
