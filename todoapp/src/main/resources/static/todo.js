...
function getTodos(){
    ...
    xhr.open("get","http://54.180.160.238:8080/api/todos");
...
function updateTodo(id){
    ...
    xhr.open('PATCH','http://54.180.160.238:8080/api/todos/'+id);
...
function deleteTodo(id){
    let delTodo = {"id": id};
    let xhr = new XMLHttpRequest();
    xhr.open('DELETE','http://54.180.160.238:8080/api/todos');
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
...
function postTodo(todo){
    let xhr = new XMLHttpRequest();
    xhr.open('post','http://54.180.160.238:8080/api/todos');
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    xhr.onload = function(){
